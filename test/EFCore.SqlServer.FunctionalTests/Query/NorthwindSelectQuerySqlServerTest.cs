...
ORDER BY [t].[OrderID], [t0].[Inner]");
        ...
        public override async Task Correlated_collection_after_distinct_with_not_containing_original_identifier(bool async)
        {
            await base.Correlated_collection_after_distinct_with_not_containing_original_identifier(async);
